    ...
    <body class="hold-transition sidebar-mini">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="" class="brand-link">
          <img
            src="dist/img/Icono_MORAMI.jpeg"
            alt="GM Logo"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            name="direccion"
                                            placeholder="Ingresa dirección del cliente" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            name="municipio"
                                            placeholder="Ingresa municipio del cliente" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            name="vendedor"
                                            placeholder="Ingresa nombre del vendedor" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div
                                            ...
                                            id="fechaCaducidadPicker"
                                            data-target-input="nearest">
                                            <input
                                                type="text"
                                                class="form-control datetimepicker-input"
                                                data-target="#fechaCaducidadPicker"
                                                name="caducidad" />
                                            <div
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        class="form-control"
                                                        name="nombre"
                                                        placeholder="Ingresa el nombre de algún producto" />
                                                </div>
                                                ...
                                                <td>
                                                    <button type="button" class="bg-gradient-warning btn-sm">
                                                        Agregar producto
                                                    </button>
                                                </td>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input
                                                            ...
                                                            name="precio"
                                                            id="precio"
                                                            placeholder="ingrese el precio en este formato 0.00" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
